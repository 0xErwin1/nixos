...
- Follow `references/skill-style-guide.md` as the normative source for skill structure and style.
...
1. Read `references/skill-style-guide.md` before creating or updating skills.
