...
These rules apply only to Codex's primary orchestrator thread, never to executor phase agents.
...
- `~/.codex/skills/_shared/sdd-orchestrator-workflow.md` owns SDD routing, preflight, phases, status, and persistence mechanics. Do not duplicate them here.
...
- Preserve Codex's irreversible-action and repository safety rules.
...
- Preserve Codex-specific models, permissions, and tool mechanics in their configured locations.
