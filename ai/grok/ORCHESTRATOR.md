...
Ask all three preflight groups in one single `question` tool call so Grok renders the groups as tabs. Do NOT run this as a sequential wizard. Do NOT issue three separate `question` tool calls.
